export enum Config {
  ...
  FA_ICON = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "faIcon",
  HIGHLIGHTED_ICON = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "highlightedIcon",
  ORDER = "http://data.sparna.fr/ontologies/sparnatural-config-core#" + "order",
  TOOLTIP = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "tooltip",
  ENABLE_OPTIONAL = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "enableOptional",
  ENABLE_NEGATION = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "enableNegation",
  ...
  EXACT_DATE_PROPERTY = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "exactDateProperty",
  BEGIN_DATE_PROPERTY = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "beginDateProperty",
  END_DATE_PROPERTY = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "endDateProperty",

  SPARNATURAL_CLASS = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "SparnaturalClass",
  NOT_INSTANTIATED_CLASS = "http://data.sparna.fr/ontologies/sparnatural-config-core#" +
    "NotInstantiatedClass",
